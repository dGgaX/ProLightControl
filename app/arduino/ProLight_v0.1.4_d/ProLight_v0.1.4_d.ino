...
String deviceVersion        = "0.1.4d";        // setze die Versionsnummer
...
void handleRoot() {
  ...
  if (server.hasArg("get") && server.arg("get") == "true") {
    ...
    message += " />&nbsp;Off<br /><input type=\"submit\" value=\"set\" /></form><hr />";
    message += "<p>Color-Code</p><form><select name=\"code\"><option value=\"\" selected=\"selected\" disabled=\"disabled\">choose</option><option value=\"0\">Red</option><option value=\"1\">???</option><option value=\"2\">???</option><option value=\"3\">???</option><option value=\"4\">Green</option><option value=\"5\">???</option><option value=\"6\">???</option><option value=\"7\">???</option><option value=\"8\">Blue</option><option value=\"9\">???</option><option value=\"10\">???</option><option value=\"11\">???</option><option value=\"12\">???</option><option value=\"13\">???</option><option value=\"14\">???</option><option value=\"15\">white</option></select>&nbsp;Code<br /><input type=\"submit\" value=\"set\" /></form><hr />";
