...
String deviceVersion        = "0.1.2";        // setze die Versionsnummer
 ...
 * ------------------------------------------------------ Die LED-Sachen -----------------------------------------------------
 */
void writeColor(unsigned int cRed, unsigned int cGreen, unsigned int cBlue) {
  unsigned int red = round((cRed * dimmer) / 1023.0f);
  unsigned int green = round((cGreen * dimmer) / 1023.0f);
  unsigned int blue = round((cBlue * dimmer) / 1023.0f);
